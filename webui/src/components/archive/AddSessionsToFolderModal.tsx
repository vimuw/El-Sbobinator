                  ...
                  {filteredSessions.map(session => {
                    ...
                    return (
                      <div
                        ...
                        className={`archive-session-card flex items-center justify-between gap-3 px-3.5 py-2.5 rounded-xl border cursor-pointer select-none transition-all ${isSelected ? 'is-selected' : ''}`}
