...
%PWS% "$wshell = New-Object -ComObject WScript.Shell; $s = $wshell.CreateShortcut('%SHORTCUT:"=%'); $s.TargetPath = '%TARGET:"=%'; $s.WorkingDirectory = '%SCRIPT_DIR:"=%'; $s.IconLocation = '%SCRIPT_DIR:"=%icon.ico'; $s.Save()"
